    ...
    getScriptLink(data) {
        ...
        return new Promise((resolve, reject) => {
            ...
            if(tag) {
                ...
                this.routes[this.currentIndex].innerHTML =  srcIndex + "<img src='/shared/router/javascript.png' onload='loadedHTMLid=" + this.routes[this.currentIndex].id + ";this.parentNode.removeChild(this);' />";
                this.rootElem.innerHTML = this.routes[this.currentIndex].innerHTML;
            } else {
